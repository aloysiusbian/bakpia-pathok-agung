...
<style>
    ...
    .payment-box {
        ...
        padding-bottom: 30px; /* Tambahan padding agar rapi */
    }
    ...
    /* Style tombol diperbarui agar terlihat seperti link tapi berfungsi tombol */
    ...
    .payment-box .btn-status:hover {
        background-color: #333;
        color: #fff;
    }

    /* Style Tambahan untuk Modal agar serasi */
