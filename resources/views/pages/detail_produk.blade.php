            ...
            <div class="col-lg-4">
                <div class="sticky-purchase">
                    ...
                    <form method="POST">
                        ...
                        <div class="card p-3" id="purchase-card" data-harga="{{ $produk->harga }}"
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <span>Subtotal:</span>
                                <h5 class="fw-bold mb-0" id="subtotal">Rp{{ number_format($produk->harga, 0, ',', '.') }}
                                </h5>
                            </div>
                            ...
                            <div class="d-grid gap-2 mt-3">
                                ...
                                <button type="submit" formaction="{{ route('pembayaran.checkout.produk') }}"
