...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-stretch">
    ...
    <div class="py-10 lg:py-16">
        ...
        <h2 class="text-3xl font-bold text-slate-800 mb-8">Welcome Back!</h2>
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            {{-- Password --}}
            <div class="border-b border-gray-300 pb-2 mt-6">
            ...
            <button type="submit" class="btn-gold text-white w-full md:w-2/3 mt-10 rounded-full py-3 text-lg shadow-lg">
                Login
            </button>
        </form>
        {{-- Form End --}}
