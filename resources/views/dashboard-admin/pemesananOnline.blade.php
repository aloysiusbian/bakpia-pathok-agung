      ...
      <div class="card-body">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
          ...
          <small class="text-muted">
            Menampilkan {{ $orders->firstItem() ?? 0 }}–{{ $orders->lastItem() ?? 0 }} dari {{ $orders->total() ?? 0 }} pesanan
          </small>
        </div>
                    ...
                    <div class="btn-group btn-group-sm" role="group">
                      ...
                      @if ($order->buktiPembayaran)
                        <button class="btn btn-outline-primary btn-lihat-bukti" data-bs-toggle="modal"
                          ...
                          data-bukti="{{ asset($order->buktiPembayaran) }}">
                      ...
                      @if ($order->statusPesanan == 'Menunggu Pembayaran' || $order->statusPesanan == 'pending')
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <table class="table table-sm table-bordered">
          ...
          <tbody>
            <tr>
              <td colspan="3" class="text-center text-muted">Data item pesanan dimuat melalui JavaScript atau Blade Component.</td>
            </tr>
          </tbody>
        </table>
      </div>
...
<style>
  ...
  .filter-select .input-group-text { background-color: #fff; border-right: none; }
  .filter-select .form-select { border-left: none; }
</style>
